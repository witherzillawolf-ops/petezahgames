  ...
  (() => {
    ...
    const p = class extends t {
      ...
      overrideWorkerLocation(t) {
        ...
        const e = this;
        for (const r of this.keys) this.ctx.overrideDescriptor(this.workerLocProto, r, { get: () => t(e.href.get.call(this.location))[r] });
        return !0;
      }
      emulate(t, e) {
        const r = {},
        ...
        return (
          ...
          this.ctx.nativeMethods.defineProperty(r, Symbol.toPrimitive, { value: () => r.href, writable: !1, enumerable: !1 }),
